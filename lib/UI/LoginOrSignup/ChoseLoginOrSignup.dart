...
import 'package:oliveagro/UI/BottomNavigationBar.dart';
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: new Carousel(
                ...
                overlayShadow: false,
                images: [
                  AssetImage("assets/img/sliderloginbg2.jpg"),
                  AssetImage('assets/img/sliderloginbg3.jpg'),
                  AssetImage("assets/img/sliderloginbg4.jpg"),
                ],
              ),
            ),
            Container(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(
                                    // AppLocalizations.of(context)
                                    //     .tr('hintChoseLogin'),
                                    "Convenient way to Buy and Sell Agricultural Produce",
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () {
                                        Navigator.of(context)
                                            .pushNamed(constants.kLoginScreen);
                                      },
                                      child: ButtonCustom(
                                          txt: AppLocalizations.of(context)
                                              .tr('login')),
